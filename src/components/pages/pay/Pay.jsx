            ...
            <Card.Body>
              ...
              <Row>
                <Col className="mt-4 mb-5">
                    ...
                    <h2 className="h5 mt-4">Возврат денежных средств</h2>
                    <p>
                      Возврат денежных средств со счёта осуществляется по заявлению через абонентский отдел.<br/>
                      Подробнее по телефону горячей линии: <a href={`tel:${help_phone}`}>{help_phone}</a>
                    </p>
                </Col>
              </Row>
            </Card.Body>
